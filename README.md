# Как сдавать домашнюю работу на GitHub
1. Каждую задачу нужно делать в отдельной ветке.
    (в терминале: git checkout -b task-1)
2. В эту ветку нужно сохранить набор изменений с решением задачи.
    (git add, git commit, ...)
3. Ветку нужно опубликовать на GitHub.
    (git push -u origin master)
    Перед этим нужно убедиться, что origin указывает на вашу копию репозитория.
    Сделать свою копию репозитория на GitHub можно с помощью кнопки Fork на GitHub.
4. Нужно выбрать ветку на GitHub и создать запрос на слияние изменений. Изменения поступят мне на проверку.
5. При наличии у меня комментариев, вы можете внести исправления в виде новых наборов изменений, или как исправления старого набора (как мы сделаем сейчас).
